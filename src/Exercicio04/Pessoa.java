...
public class Pessoa {
    ...
    public void exibirdados(String nome, int idade, String cidadeDeNascimento){
        System.out.println("meu nome é "+ nome + " tenho "+ idade + " anos e moro em "+ cidadeDeNascimento);
    }
